...
export const SOLAR_TERMS = {
  lesser_cold: 'Tiểu hàn',
  greater_cold: 'Đại hàn',
  the_beginning_of_spring: 'Lập xuân',
  rain_water: 'Vũ thủy',
  the_waking_of_insects: 'Kinh trập',
  the_spring_equinox: 'Xuân phân',
  pure_brightness: 'Thanh minh',
  grain_rain: 'Cốc vũ',
  the_beginning_of_summer: 'Lập hạ',
  lesser_fullness_of_grain: 'Tiểu mãn',
  grain_in_beard: 'Mang chủng',
  the_summer_solstice: 'Hạ chí',
  lesser_heat: 'Tiểu thử',
  greater_heat: 'Đại thử',
  the_beginning_of_autumn: 'Lập thu',
  the_end_of_heat: 'Xử thử',
  white_dew: 'Bạch lộ',
  the_autumn_equinox: 'Thu phân',
  code_dew: 'Hàn lộ',
  frost_descent: 'Sương giáng',
  the_beginning_of_winter: 'Lập đông',
  lesser_snow: 'Tiểu tuyết',
  greater_snow: 'Đại tuyết',
  the_winter_solstice: 'Đông chí',
};
